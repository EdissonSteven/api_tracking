...
class TestUnitRepository:
    @pytest.mark.asyncio
    def test_save_and_find_unit(self, test_session):
        ...
        # Find unit
        found_unit = repo.find_by_tracking_id(tracking_id)
    ...
    @pytest.mark.asyncio
    def test_find_units_by_status(self, test_session):
        ...
        units = repo.find_by_status(UnitStatus.CREATED, limit=10)
